...
from schedules.views import MemberTypeViewSet, StyleTypeViewSet, ScheduleViewSet, UserScheduleViewSet, CourseMemoViewSet, ScheduleAdviceViewSet, CourseViewSet
