<template>
  <v-container style="padding:0;">
    ...
    <v-row style="display: flex; justify-content: space-around; margin-top: -4vw; margin-bottom: 1vw;">
      <img v-if="schedule.together==1" src="@/assets/friend.png" alt="" style="width: 3vw; z-index: 100;">
      <img v-if="!test" src="@/assets/trans.png" style="width: 3vw; z-index: 100;"/>
      <img v-if="schedule.advice==1" src="@/assets/help2.png" alt="" style="width: 3vw; z-index: 100;">
    </v-row>
